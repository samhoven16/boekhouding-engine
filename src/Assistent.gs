  ...
  const faq = [
    {
      ...
      items: [
        { v: 'Hoe maak ik een factuur?',
          a: 'Klik bovenin op <b>Boekhoudbaar → Nieuw invoeren</b>. Kies "Inkomsten (factuur maken)", vul de gegevens in en klik op verzenden. De factuur (PDF) wordt automatisch aangemaakt en per e-mail naar uw klant gestuurd.' },
        ...
        { v: 'Hoe stuur ik een betalingsherinnering?',
          a: 'Het systeem stuurt automatisch herinneringen na 1, 7 en 14 dagen na de vervaldatum. Wilt u het nu doen? Ga naar <b>Boekhoudbaar → Facturen → Betalingsherinneringen versturen</b>.' },
    ...
    },
    {
      ...
      items: [
        { v: 'Hoe maak ik een balans?',
          a: 'Ga naar <b>Boekhoudbaar → Overzichten → Balans</b>. U ziet dan een overzicht van uw bezittingen (activa) en schulden (passiva).' },
        ...
        { v: 'Hoe deel ik mijn administratie met mijn accountant?',
          a: 'Ga naar <b>Boekhoudbaar → Overzichten → Jaarrekening</b>. Dit genereert een compleet rapport dat u kunt delen.' },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { v: 'Hoe maak ik een creditnota (factuur terugdraaien)?',
          a: 'Ga naar <b>Boekhoudbaar → Facturen → Creditnota maken van factuur</b>. Kies de factuur die je wilt crediteren; het systeem maakt automatisch de tegenboeking.' },
