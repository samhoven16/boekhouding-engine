  ...
  // ── GAS bronbestanden ──────────────────────────────────────────────────
  {
    ...
    rules: {
      ...
      'no-unused-vars': ['warn', {
        ...
        varsIgnorePattern: '^(on[A-Z]|do[A-Z]|open|toon|stuur|sluit|beheer|importeer|exporteer|genereer|bereken|verwerk|controleer|instell|instel|maak|reset|sla|herlaad|vernieuw|initialiseer)|\\w+_$',
        argsIgnorePattern: '^_',
      }],
